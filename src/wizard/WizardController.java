...
/**
 * r.nagel
 * insert a last-button-clicked flag for detecting the flow of wizard control
 */
...
public class WizardController implements ActionListener
{
  ...
  private void nextButtonPressed()
  {
    ...
    // denote the button
    wizard.setLastButtonClicked( Wizard.LAST_BUTTON_NEXT ) ;
  ...
  private void backButtonPressed()
  {
    ...
    // denote the button
    wizard.setLastButtonClicked( Wizard.LAST_BUTTON_BACK ) ;
  ...
  void resetButtonsToPanelRules()
  {
    ...
    // next and finish button are the same
    if ( !model.isExtraFinishButton() )
    {
      if ( descriptor.getNextPanelDescriptor() instanceof WizardPanelDescriptor.
           FinishIdentifier )
      {
    ...
    else // different finish and next button
    {
      model.setNextFinishButtonText( Wizard.NEXT_TEXT ) ;
      model.setNextFinishButtonIcon( Wizard.NEXT_ICON ) ;
      model.setFinishButtonText( Wizard.FINISH_TEXT ) ;
      model.setFinishButtonIcon( Wizard.FINISH_ICON ) ;
      ...
      else if ( descriptor.canFinished() )
      {
        model.setNextFinishButtonEnabled( Boolean.TRUE ) ;
        model.setFinishButtonEnabled( Boolean.TRUE ) ;
      }
