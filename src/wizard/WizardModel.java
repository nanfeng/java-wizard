...
public class WizardModel
{
  ...
  public static final String FINISH_BUTTON_ICON_PROPERTY =
      "finishButtonIconProperty" ;

  public static final String FINISH_BUTTON_ENABLED_PROPERTY =
  ...
  private boolean extraFinishButton = false ;

  private PropertyChangeSupport propertyChangeSupport ;

  /**
   * Default constructor, 3 button style
   */
  public WizardModel()
  {
  ...
  /** set the 3 button (prev, next/finish, cancel) or the
   *  4 button (prev, next, finish, cancel) style  */
  public WizardModel( boolean extraFinishButtonStyle)
  {
    this() ;
    extraFinishButton = extraFinishButtonStyle ;
  }

  /** 3 or 4 Button style */
  public boolean isExtraFinishButton()
  {
    return this.extraFinishButton ;
  }
  ...
  protected Object getFinishButtonText()
  {
    return buttonTextHashmap.get( FINISH_BUTTON_TEXT_PROPERTY ) ;
  }
  ...
  void setFinishButtonText( Object newText )
  {
    ...
    if ( !newText.equals( oldText ) )
    {
      buttonTextHashmap.put( FINISH_BUTTON_TEXT_PROPERTY, newText ) ;
  ...
  {
    return ( Icon ) buttonIconHashmap.get( FINISH_BUTTON_ICON_PROPERTY ) ;
  }

  protected void setFinishButtonIcon( Icon newIcon )
  {

    Object oldIcon = getFinishButtonIcon() ;
    if ( !newIcon.equals( oldIcon ) )
    {
      buttonIconHashmap.put( FINISH_BUTTON_ICON_PROPERTY, newIcon ) ;
      firePropertyChange( FINISH_BUTTON_ICON_PROPERTY, oldIcon, newIcon ) ;
    }
  }

  protected Boolean getFinishButtonEnabled()
  {
    return ( Boolean ) buttonEnabledHashmap.get(
        FINISH_BUTTON_ENABLED_PROPERTY ) ;
  }

  protected void setFinishButtonEnabled( Boolean newValue )
  {

    Boolean oldValue = getFinishButtonEnabled() ;
    if ( newValue != oldValue )
    {
      buttonEnabledHashmap.put( FINISH_BUTTON_ENABLED_PROPERTY, newValue ) ;
  ...
  // -------------------------------------------------------------------------
  protected Icon getBackButtonIcon()
  {
